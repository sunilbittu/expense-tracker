  ...
  const filteredPayments = useMemo(() => {
    return customerPayments.filter((payment) => {
      ...
      if (filters.searchQuery) {
        ...
        const matchesInvoice = payment.invoiceNumber?.toLowerCase().includes(query);
        
        return matchesDescription || matchesCustomer || matchesProject || matchesInvoice;
      }
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        {currentPayments.length > 0 ? (
          ...
          <div className="p-8 text-center">
            <p className="text-gray-500 mb-4">No customer payments found</p>
